...
class Model3():
    ...
    def data_preparation(self) -> Model3: 
    ...
    def build_model(self) -> Model3: 
        ...
        self.builder = ModelBuilder() \
            .add([builder.get_model().output for _, builder in self.builders.items()]) \
            .dense(10) \
            .dense(2) \
    ...
    def train_model(self) -> Model3: 
        self.builder \
        .softmax() \
        .build_model(inputs=[builder.get_model().input for _, builder in self.builders.items()]) \
        .plot()
        self.builder.train(
            self.flows_train, 
    ...
    def evaluate_model(self) -> Model3:
        self.builder.get_model().evaluate(
            self.flows_validation,
            self.labels[self.train_count:],
            batch_size=Model3.BATCH_SIZE,
            verbose=2,
        )
        return self
